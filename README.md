...
- Az alkalmazás nyitóképernyőjén jeleníts meg:
    o Egy szöveges beviteli mezőt
    o Egy keresést indító gombot
    o A beviteli mezőben a keresési feltételek megadhatók kulcsszavakkal és
...
- Egy listaelem tartalmazza az alábbi adatokat:
    ...
    o Leírás
    o Csillagok száma
    o Utolsó frissítés időpontja
- Egy listaelem kiválasztása után egy részletes képernyőn jelenítsd meg a repository
    további adatait:
       o Tulajdonos neve, avatárja és egy link a GitHub profiljára
       o Név
       o Leírás
       o GitHub repository link
       o Csillagok száma
       o Forkok száma
       o Létrehozás időpontja
       o Utolsó frissítés időpontja
